...
class AgendaTest {
    ...
    private val hoy: LocalDate = LocalDate.of(2026, 9, 3)
    ...
    @Test fun `lo cercano en dias y lo lejano en fecha`() {
        assertEquals("mañana", Novedades.cuandoSale(LocalDate.of(2026, 9, 4), hoy))
        assertEquals("en 3 días", Novedades.cuandoSale(LocalDate.of(2026, 9, 6), hoy))
        assertEquals("en 6 días", Novedades.cuandoSale(LocalDate.of(2026, 9, 9), hoy))
        assertEquals("el 10 de septiembre", Novedades.cuandoSale(LocalDate.of(2026, 9, 10), hoy))
    }

    /** El año solo cuando no es el de este año. */
    @Test fun `el año solo cuando hace falta`() {
        assertEquals("el 15 de enero de 2027",
            Novedades.cuandoSale(LocalDate.of(2027, 1, 15), hoy))
    }
}
